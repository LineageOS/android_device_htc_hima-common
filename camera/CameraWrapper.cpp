...
static bool is4k(CameraParameters &params) {
...
static int camera_start_recording(struct camera_device *device)
{
    ...
    /* HTC Camera HAL produces yuv420sp format */
    parameters.set(CameraParameters::KEY_VIDEO_FRAME_FORMAT, CameraParameters::PIXEL_FORMAT_YUV420SP);
    camera_set_parameters(device,  strdup(parameters.flatten().string()));

    parameters.unflatten(String8(VENDOR_CALL(device, get_parameters)));
    parameters.dump();
