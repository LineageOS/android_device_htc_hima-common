...
public class TouchscreenGestures {
    ...
    /**
     * Enumerate the supported gestures with a random keycode
     * only to avoid breakage while checking for available gestures
     */
    private static final TouchscreenGesture[] TOUCHSCREEN_GESTURES = {
        new TouchscreenGesture(0, "Swipe up", 255),
        new TouchscreenGesture(1, "Swipe down", 256),
        new TouchscreenGesture(2, "Swipe left", 257),
        new TouchscreenGesture(3, "Swipe right", 258),
    };
