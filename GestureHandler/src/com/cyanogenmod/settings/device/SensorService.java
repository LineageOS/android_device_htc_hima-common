...
public class SensorService extends Service implements SensorEventListener {
    ...
    // For future use:
    // values of /sys/class/htc_sensorhub/sensor_hub/gesture_motion
    // add them together (base 16) for enabling multiple gestures
    // Double tap: 8000
    // Swipe up:      4
    // Swipe down:    8
    // Swipe left:   10
    // Swipe right:  20
    // Camera:       40  (volume buttons to launch camera i guess?)
